...
function displayAchievements() {
    ...
    const messageText = document.createElement('div');
    messageText.className = 'message-text';
    messageText.innerHTML = `你完成了這段冒險旅程，這是你獲得的成就：<br>${achievements.join('<br>')}`;
...
function showAllAchievements() {
    ...
    achievementContainer.innerHTML = `<div class="achievement-content">你獲得的成就：<br>${achievementList}</div>`;
    document.body.appendChild(achievementContainer);
